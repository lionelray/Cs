<%@ Page Language="C#" AutoEventWireup="true" CodeFile="csearch.aspx.cs" Inherits="csearch" %>
...
<form id="form1" runat="server">
  ...
  <span class="test">
  <div>
    <asp:Label ID="Label3" ForeColor="#CCCCCC" runat="server" Text="耗材信息查询："></asp:Label>
    <br />
    ...
    <br />
    <br />
    <asp:Label ID="Label1" ForeColor="#CCCCCC" runat="server" Text=""></asp:Label>
    <br />
    <br />
    <asp:Label ID="Label2" ForeColor="#CCCCCC" runat="server" Text=""></asp:Label>
