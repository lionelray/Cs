<%@ Page Language="C#" AutoEventWireup="true" CodeFile="instc.aspx.cs" Inherits="instc" %>
...
<form id="form1" runat="server">
  ...
  <table style="WIDTH: 395px">
    <tr>
      <td style="WIDTH: 97px"> 耗材编号</td>
      <td class="auto-style1"><asp:TextBox ID="TextBox1" runat="server" Width="120px"></asp:TextBox></td>
    </tr>
    <tr>
      <td class="auto-style2">耗材名称</td>
      <td class="auto-style3"><asp:TextBox ID="TextBox2" runat="server" Height="18px" Width="122px"></asp:TextBox></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="auto-style1"><asp:DropDownList ID="DropDownList1" runat="server"> </asp:DropDownList>
        <asp:TextBox ID="TextBox4" runat="server" Width="62px"></asp:TextBox>
        &nbsp;
        <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" Text="添加" style="height: 21px" /></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="WIDTH: 248px; HEIGHT: 40px"><asp:TextBox ID="TextBox7" runat="server" Height="18px" Width="122px"></asp:TextBox></td>
    </tr>
    <tr>
  ...
  <div> &nbsp;
    ...
    &nbsp;&nbsp;
    <asp:Button ID="Button2" runat="server" onclick="Button2_Click" Text="返回上页" />
  </div>
</form>
</span>
</div>
