...
<form id="form1" runat="server">
  ...
  <div class="div-b">
  <span class="test">
  <fieldset style="width:500px; position:relative; left:300px">
    <legend style="color:#FFF">个人信息编辑</legend>
    <table style="WIDTH: 395px">
      <tr>
        <td style="WIDTH: 85px; HEIGHT: 40px">用户编号</td>
        <td style="WIDTH: 248px; HEIGHT: 40px"><asp:Label ID="Label6" runat="server"></asp:Label></td>
      </tr>
      <tr>
    ...
    <br />
    &nbsp;&nbsp;
    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="修改" Width="71px" />
    &nbsp;&nbsp; <br />
  </fieldset>
</form>
</span>
