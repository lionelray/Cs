 ...
 */
 //二维码右下角弹窗
 document.write('<div id="china_ads_div405" style="position:absolute;top:100px;z-index:2000;width:126px">');
document.write('<div style="position:absolute;top:200px;z-index:2000;text-align:right;padding-right:5px;font-weight:700;cursor: pointer;font-size:12px;color:#000067;background:#CAEBFE;border:1px #245286 solid;border-bottom:0" onclick="document.getElementById(\'china_ads_div405\').style.display=\'none\'">关闭</div>');
document.write('<div style="position:absolute;top:100px;z-index:2000;width:126px"><a href="tencent://message/?uin=269505494&Site=http://www.zzjs.net/&Menu=yes" target="_blank"><img src="qrcode.png" width="126" height="126" border="0"></a><div style="background:#CAEBFE;text-align:center;color:#000;font-family:黑体">扫一扫<br>点击二维码请求帮助</div></div>');
document.write('</div>');
 var Class = {
   create: function() {
     return function() {
