...
<form id="form1" runat="server">
  ...
  <div>
    <fieldset style="width:300px">
      <legend style="color:#FFF">用户信息编辑</legend>
      <table style="WIDTH: 395px">
        <tr>
          <td style="WIDTH: 85px; HEIGHT: 40px">用户编号</td>
        ...
        <tr>
          <td style="WIDTH: 85px; HEIGHT: 40px">用户名</td>
          <td style="WIDTH: 248px; HEIGHT: 40px"><asp:TextBox ID="TextBox1" runat="server" Height="18px" Width="122px"></asp:TextBox></td>
        </tr>
        <tr>
          <td style="WIDTH: 85px; HEIGHT: 40px">用户密码</td>
          <td style="WIDTH: 248px; HEIGHT: 40px"><asp:TextBox ID="TextBox2" runat="server" Height="18px" Width="122px"></asp:TextBox></td>
        </tr>
        <tr>
          <td style="WIDTH: 85px; HEIGHT: 40px">用户类型</td>
          <td class="auto-style1"><asp:DropDownList ID="DropDownList3" runat="server" DataSourceID="SqlDataSource1" DataTextField="I_name" DataValueField="I_name"> </asp:DropDownList>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:LCMISConnectionString %>" SelectCommand="SELECT [I_name] FROM [IDentity]"></asp:SqlDataSource></td>
        </tr>
        <tr>
          <td style="WIDTH: 85px; HEIGHT: 40px">备注</td>
          <td style="WIDTH: 248px; HEIGHT: 40px"><asp:TextBox ID="TextBox3" runat="server" Height="18px" Width="122px"></asp:TextBox></td>
        </tr>
        <tr>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="U_id">
      <Columns>
      <asp:BoundField DataField="U_id" HeaderText="用户编号" ReadOnly="True" SortExpression="U_id" />
      <asp:BoundField DataField="U_name" HeaderText="用户名" SortExpression="U_name" />
      <asp:BoundField DataField="I_name" HeaderText="用户类型" SortExpression="I_name" />
      <asp:BoundField DataField="U_remarks" HeaderText="备注" SortExpression="U_remarks" />
      </Columns>
    </asp:GridView>
    <br />
  </div>
