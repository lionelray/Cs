<%@ Page Language="C#" AutoEventWireup="true" CodeFile="outstock.aspx.cs" Inherits="outstock" %>
...
<form id="form1" runat="server">
  ...
  <span class="test">
  <div>
    <asp:Label ID="Label1" ForeColor="#CCCCCC" runat="server" Text="已出库耗材："></asp:Label>
    <br />
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="S_sn" DataSourceID="SqlDataSource1">
      <Columns>
      ...
      <asp:BoundField DataField="S_outtime" HeaderText="出库时间" SortExpression="S_outtime" />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:LCMISConnectionString %>" SelectCommand="SELECT * FROM [out_Stock]"></asp:SqlDataSource>
  </div>
</form>
</span>
</div>
