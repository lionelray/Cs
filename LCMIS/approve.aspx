...
<form id="form1" runat="server">
  ...
  <div>
    <fieldset style="width:500px">
      <legend style="color:#FFF">耗材审批</legend>
      <table style="WIDTH: 395px">
        <tr>
          <td style="WIDTH: 85px; HEIGHT: 40px">申请编号</td>
        ...
        <tr>
          ...
          <td style="WIDTH: 248px; HEIGHT: 40px"><asp:Label ID="Label1" runat="server" Text="Label"></asp:Label></td>
        </tr>
        <tr>
          <td style="WIDTH: 85px; HEIGHT: 40px">耗材名称</td>
          <td style="WIDTH: 248px; HEIGHT: 40px"><asp:Label ID="Label2" runat="server" Text="Label"></asp:Label></td>
        </tr>
        <tr>
          <td style="WIDTH: 85px; HEIGHT: 40px">申请用户</td>
          <td class="auto-style1"><asp:Label ID="Label3" runat="server" Text="Label"></asp:Label></td>
        </tr>
        <tr>
          <td style="WIDTH: 85px; HEIGHT: 40px">申请日期</td>
          <td style="WIDTH: 248px; HEIGHT: 40px"><asp:Label ID="Label4" runat="server" Text="Label"></asp:Label></td>
        </tr>
        <tr>
          <td style="WIDTH: 85px; HEIGHT: 40px">申请数量</td>
          <td style="WIDTH: 248px; HEIGHT: 40px"><asp:Label ID="Label5" runat="server" Text="Label"></asp:Label></td>
        </tr>
        <tr>
          <td class="auto-style1" colspan="2"><asp:Label ID="Label6" runat="server" ForeColor="Green" Width="379px"></asp:Label></td>
        </tr>
      </table>
      &nbsp;&nbsp;&nbsp;
      <asp:Button ID="Button1" runat="server" Height="24px" onclick="Button1_Click" Text="批准采购" Width="66px" />
      &nbsp;&nbsp;&nbsp;
      <asp:Button ID="Button2" runat="server" Height="24px" OnClick="Button2_Click" Text="拒绝" Width="65px" />
      <br />
    </fieldset>
    <br />
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="C_id">
      <Columns>
      <asp:BoundField DataField="A_id" HeaderText="申请编号" ReadOnly="True" SortExpression="A_id" />
      ...
      <asp:BoundField DataField="U_name" HeaderText="申请用户" SortExpression="U_name" />
      <asp:BoundField DataField="A_date" HeaderText="申请日期" SortExpression="A_date" />
      <asp:BoundField DataField="A_number" HeaderText="申请数量" SortExpression="A_number" />
      </Columns>
    </asp:GridView>
  </div>
</form>
