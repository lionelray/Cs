<%@ Page Language="C#" AutoEventWireup="true" CodeFile="instock.aspx.cs" Inherits="instock" %>
...
<form id="form1" runat="server">
  ...
  <span class="test">
  <div>
    <asp:Label ID="Label4" ForeColor="#CCCCCC" runat="server" Text="耗材出入库："></asp:Label>
    </br>
    <br />
    <asp:TextBox ID="TextBox1" runat="server" value="请输入需要出入库的序列号范围" size="30"    
          onmouseover=this.focus();this.select();   
          onclick="if (value == defaultValue) { value = ''; this.style.color = '#000' }"    
           onBlur="if(!value){value=defaultValue;this.style.color='#999'}" style="color:#999" Width="173px" ></asp:TextBox>
    &nbsp;至
    <asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
    &nbsp; <br />
    <br />
    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="确认出库" style="height: 21px" />
    &nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" Text="确认入库" />
    <br />
    <br />
    <hr color="#cc0066" align="center" width="100%" size ="20">
    <asp:Label ID="Label1" ForeColor="#CCCCCC" runat="server" Text="已入库耗材："></asp:Label>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="导出入库表" />
    <br />
    <br />
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="S_sn" DataSourceID="SqlDataSource2" AllowSorting="True">
      <Columns>
      <asp:BoundField DataField="S_sn" HeaderText="库存序列号" ReadOnly="True" SortExpression="S_sn" />
      <asp:BoundField DataField="C_id" HeaderText="耗材编号" SortExpression="C_id" />
      <asp:BoundField DataField="C_name" HeaderText="耗材名称" SortExpression="C_name" />
      <asp:BoundField DataField="T_name" HeaderText="类别" SortExpression="T_name" />
      <asp:BoundField DataField="C_model" HeaderText="型号" SortExpression="C_model" />
      <asp:BoundField DataField="S_intime" HeaderText="入库时间" SortExpression="S_intime" />
      </Columns>
    </asp:GridView>
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:LCMISConnectionString %>" SelectCommand="SELECT * FROM [in_Stock]"></asp:SqlDataSource>
    &nbsp;
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:LCMISConnectionString %>" SelectCommand="SELECT * FROM [purchase_Stock]"></asp:SqlDataSource>
    &nbsp;<br />
    <hr color="#cc0066" align="center" width="100%" size ="20">
    <asp:Label ID="Label2" ForeColor="#CCCCCC" runat="server" Text="未入库耗材："></asp:Label>
    <br />
    <asp:GridView ID="GridView2" runat="server" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="S_sn" DataSourceID="SqlDataSource1" Width="596px">
      <Columns>
      <asp:BoundField DataField="S_sn" HeaderText="序列号" ReadOnly="True" SortExpression="S_sn" />
      <asp:BoundField DataField="C_id" HeaderText="耗材编号" SortExpression="C_id" />
      <asp:BoundField DataField="C_name" HeaderText="耗材名称" SortExpression="C_name" />
      <asp:BoundField DataField="T_name" HeaderText="类别" SortExpression="T_name" />
      <asp:BoundField DataField="C_model" HeaderText="型号" SortExpression="C_model" />
