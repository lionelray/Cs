...
<form id="form1" runat="server">
  ...
  <div class="div-b"> <span class="test">
    <asp:Label ID="Label3" ForeColor="#CCCCCC" runat="server" Text="库存信息查询："></asp:Label>
    <br />
    <br />
    <asp:TextBox ID="TextBox1" runat="server" value="请输入你要检索的关键词" size="30"    
          onmouseover=this.focus();this.select();   
          onclick="if (value == defaultValue) { value = ''; this.style.color = '#000' }"    
           onBlur="if(!value){value=defaultValue;this.style.color='#999'}" style="color:#999" ></asp:TextBox>
    &nbsp;&nbsp;
    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="搜索" Width="53px" />
    <br />
    <br />
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="C_id">
      <Columns>
      <asp:BoundField DataField="S_sn" HeaderText="序列号" SortExpression="S_sn" />
      ...
      <asp:BoundField DataField="S_mark" HeaderText="状态" SortExpression="S_mark" />
