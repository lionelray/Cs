<%@ Page Language="C#" AutoEventWireup="true" CodeFile="instu.aspx.cs" Inherits="instu" %>
...
<form id="form1" runat="server">
  ...
  <div>
    ...
    &nbsp;&nbsp;&nbsp;
    <asp:Button ID="Button1" runat="server" Height="24px" onclick="Button1_Click" Text="确认添加" Width="66px" />
    &nbsp;&nbsp;
    <asp:Button ID="Button2" runat="server" Height="24px" onclick="Button2_Click" Text="返回" Width="66px" />
    &nbsp;<br />
  </div>
</form>
</span>
